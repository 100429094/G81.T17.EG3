...
class TestAccessRequest(TestCase):
    ...
    def test_AM_FR_01_I2_resident(self):
        ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Resident", email_address="100429094@alumnos.uc3m.es", validity=0)
    ...
    def test_AM_FR_01_I4_email_vacio(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="", validity=3)
    ...
    def test_AM_FR_01_I4_email_sin_arroba(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094alumnos.uc3m.es", validity=3)

    def test_AM_FR_01_I4_email_sin_company(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@.es", validity=3)

    def test_AM_FR_01_I4_email_sin_punto(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnoses", validity=3)

    def test_AM_FR_01_I4_email_sin_com(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.", validity=3)

    def test_AM_FR_01_I4_email_caracter_invalido(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alum!os.uc3m.es", validity=3)

    def test_AM_FR_01_I5_validity_guest_1(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.uc3m.es", validity=1)

    def test_AM_FR_01_I5_validity_guest_2(self):
        ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.uc3m.es", validity=2)
    ...
    def test_AM_FR_01_I5_validity_guest_14(self):
        ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.uc3m.es", validity=14)
        self.assertEqual(ar.access_code, "2c3332d44cc5ef4c63af11fefd9b4f18")

    def test_AM_FR_01_I5_validity_guest_15(self):
        ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.uc3m.es", validity=15)
        self.assertEqual(ar.access_code, "e5148debcfde73b070d3bc94849a0834")

    def test_AM_FR_01_I5_validity_guest_16(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Guest", email_address="100429094@alumnos.uc3m.es", validity=16)
    ...
    def test_AM_FR_01_I5_validity_resident_1(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Resident", email_address="100429094@alumnos.uc3m.es", validity=1)

    def test_AM_FR_01_I5_validity_resident_2(self):
        with self.assertRaises(AccessManagementException) as AME:
            ar = AccessRequest(id_document="12345678Z", full_name="Beatriz Benitez", access_type="Resident", email_address="100429094@alumnos.uc3m.es", validity=2)
